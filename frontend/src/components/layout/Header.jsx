...
export default function Header({
  ...
  return (
    <header className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-3.5 lg:py-4 flex flex-row items-center justify-between gap-3 sm:gap-4 sticky top-0 z-10 shadow-xs">
